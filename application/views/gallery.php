...
<div id="container">
    ...
    <img style="position: absolute;margin-left: 50px;margin-top: 50px;" src="<?php echo base_url(); ?>images/asset/tittle-gallery.png">
    <div id="content" >
        <div style="padding: 50px;">
	<p>
            
            <?php for($i=1 ; $i<=15 ; $i++): ?>
                <a class="fancybox" href="<?php echo base_url(); ?>images/gallery/<?php echo $i; ?>.jpg" data-fancybox-group="gallery" title="Life Saver - <?php echo $i; ?>">
                <img src="<?php echo base_url(); ?>images/gallery/<?php echo $i; ?>.jpg" width="180" height="150" alt="" /></a>
            <?php endfor;?>
