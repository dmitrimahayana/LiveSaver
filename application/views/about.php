...
<div id="container">
    <div id="header">
		...
		<li class="llii home-menu">
                    <p class="pp"><a class="aa" href="<?php echo base_url(); ?>beranda">Home</a></p>
		</li>
    ...
    <img style="position: absolute;margin-left: 50px;margin-top: 50px;" src="<?php echo base_url(); ?>images/asset/tittle-aboutUs.png">
    <div id="content" >
        <div style="padding: 80px;">
            <table  >
                <tr>
                    <td>
                        <a class="fancybox" href="<?php echo base_url(); ?>images/about1.jpg" data-fancybox-group="gallery" title="Muhammad hanif Budiarto">
                            <img src="<?php echo base_url(); ?>images/about1.jpg" width="220" height="320" alt="" />
                        </a>
                    </td>
                    <td>
                        <a class="fancybox" href="<?php echo base_url(); ?>images/about2.jpg" data-fancybox-group="gallery" title="Dmitri Yanno Mahayana">
                            <img src="<?php echo base_url(); ?>images/about2.jpg" width="250" height="320" alt="" />
                        </a>
                    </td>
                    <td>
                        <a class="fancybox" href="<?php echo base_url(); ?>images/about3.jpg" data-fancybox-group="gallery" title="Hans Alfons Erickson">
                            <img src="<?php echo base_url(); ?>images/about3.jpg" width="250" height="320" alt="" />
                        </a>
                    </td>
                </tr>
                <tr>
                    <td style="font-size: 13pt;font-weight:bold;">M. Hanif Budiarto</td>
                    <td style="font-size: 13pt;font-weight:bold;">Dmitri Yanno Mahayana</td>
                    <td style="font-size: 13pt;font-weight:bold;">Hans Alfons Erickson</td>
                </tr>
                <tr>
                    <td style="font-style: italic;font-weight:bold;color: orangered;">Project Manager and Analyst</td>
                    <td style="font-style: italic;font-weight:bold;color: orangered;">Core Programmer</td>
                    <td style="font-style: italic;font-weight:bold;color: orangered;">Designer User Interface</td>
                </tr>
            </table>
        </div>
    </div>
